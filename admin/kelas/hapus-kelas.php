...
try {
	$query_tambah_kelas = "DELETE FROM kelas WHERE id_kelas=:id_kelas LIMIT 1";
...
START TRANSACTION;
DELETE FROM <code class="text-green-400">kelas</code> WHERE <code class="text-pink-400">id_kelas</code>=<code class="text-blue-400"><?=$_GET['id_kelas'] ?></code> LIMIT 1;
COMMIT;</pre>
						</div>
					</div>
					<?php 
