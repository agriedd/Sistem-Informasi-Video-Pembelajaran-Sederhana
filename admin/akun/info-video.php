							...
							<div class="p-1 rounded-full bg-slate-100">
								<ul class="flex gap-1">
									...
									<li class="transition-all duration-75 px-4 py-2 rounded-full text-slate-600 hover:text-slate-400 bg-slate-300">
										<a href="/admin/kelas/ubah-video.php?id_kelas=<?= $video->id_kelas ?>&id_video=<?= $video->id_video ?>" class="text-sm">
											ubah
										</a>
									</li>
								</ul>
...
SELECT <code class="text-pink-400">id_video</code>, <code class="text-pink-400">judul_video</code>, <code class="text-pink-400">keterangan</code>, <code class="text-pink-400">video</code>, <code class="text-pink-400">id_kelas</code>, <code class="text-pink-400">tanggal</code> 
	FROM <code class="text-green-400">video_pembelajaran</code> 
	WHERE <code class="text-pink-400">id_video</code> = <code class="text-blue-400"><?=$_GET['id_video'] ?></code> LIMIT 1;</pre>
						</div>
					</div>
					<?php
					if ($_GET['sukses'] ?? '0' == 1) :
