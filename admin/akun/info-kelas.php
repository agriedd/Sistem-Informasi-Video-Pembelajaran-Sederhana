						...
						<ul class="grid grid-cols-1 divide-y divide-solid">
							...
							?>
									<li class="flex">
										...
										<div class="ml-auto">
											<a href="./hapus-video.php?id_kelas=<?=$_GET['id_kelas'] ?>&id_video=<?=$video->id_video ?>" title="Hapus" class="flex p-6 bg-red-100 fill-red-600 h-full justify-center items-center
